...
from src.utils.utils import AvgrageMeter, accuracy
...
class GrowableModel(nn.Module):
    ...
    default_config = {
        ...
        #'max_params': 1e8,
        'n_channels_conv_0': (8, 128),  # (initial, maximum) number of channels
        'n_channels_conv_1': (8, 128),
        'n_channels_conv_2': (8, 128),
        'n_channels_conv_3': (8, 128),
        'n_channels_conv_4': (8, 128),
        'n_features_fc_0': (8, 2**10),
        'n_features_fc_1': (8, 2**10),
        'n_features_fc_2': (8, 2**10),
        'kernel_size': 3,
    ...
    def train_fn(self, optimizer, criterion, loader, device, train=True, grow=True):
        """
        Training method
